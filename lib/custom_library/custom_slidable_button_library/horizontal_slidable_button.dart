...
class HorizontalSlidableButton extends StatefulWidget {
  ...
  final Function(SlidableButtonPosition) onChanged;
  final Function(double) onTapDown;
  ...
  @override
  State<HorizontalSlidableButton> createState() => _HorizontalSlidableButtonState();
}

class _HorizontalSlidableButtonState extends State<HorizontalSlidableButton> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _controller = widget.controller ?? AnimationController.unbounded(vsync: this);
    _contentAnimation =
        ...
        children: <Widget>[
          ...
          AnimatedBuilder(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: widget.borderRadius,
                color: widget.onChanged == null ? widget.disabledColor ?? Colors.grey : widget.buttonColor,
              ),
  ...
  void _onDragUpdate(DragUpdateDetails details) {
    ...
    widget.onTapDown(_controller.value);
