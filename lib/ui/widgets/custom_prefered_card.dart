...
class CustomPreferredCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (choose == 'One') {
      ...
      content =
          'We will match you with one person on campus, according to your preference.';
    } else if (choose == 'F2F') {
      title = 'F2F Group Connection';
      content =
          'We will plan a meeting for you with a group of 4 people on campus, according to your preference.';
